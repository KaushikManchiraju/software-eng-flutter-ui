...
import 'package:group_chat_room_responsive/services/firestore_upload.dart';
...
class _MessagingPageState extends State<MessagingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Purdue Web Chat | Login | Spam filter"),
      ),
      body: Padding(
              ...
              if (!snapshot.hasData) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) => Container(
                    child: Row(
                      children: [
                        snapshot.data.documents[index].get('ham-or-spam') == ""
                            ? SizedBox(
                                width: 24.0,
                                height: 24.0,
                                child: Center(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8.0),
                              Expanded(
                                  child: snapshot.data.documents[index].get('ham-or-spam') == "true"
                                      ? Text(
                                      ...
                                      : Text(
                                          snapshot
                                              .data.documents[index].get('message')
                                              .toString(),
                                          textAlign: TextAlign.left,
                                        )),
                            ],
