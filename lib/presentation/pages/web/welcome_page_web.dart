...
import 'package:group_chat_room_responsive/presentation/screens/messaging_page.dart';
    ...
    return Align(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Text(
              "Click on Join Now to start connecting with friends!",
              style: TextStyle(
                fontSize: 30,
                fontWeight: FontWeight.bold,
              ),
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => MessagingPage(username: name),
                  ),
                );
              },
              child: Container(
